  ...
  const approaches: any = {
    ...
    'explicit': {
      ...
      performance: {
        ...
        gpt4: { accuracy: 70, reasoning: "Good belief refinement but sometimes modified correct beliefs" }
      }
    },
    'given': {
              ...
              <table className="payoff-table">
                <thead>
                  <tr>
                    ...
                    <th className="table-cell empty-cell"></th>
                    <th className="table-cell header-cell" colSpan={2}>Opponent</th>
                  </tr>
                  <tr>
                    <th className="table-cell empty-cell"></th>
                    <th className="table-cell empty-cell"></th>
                ...
                <tbody>
                  <tr>
                    <th className="table-cell player-header" rowSpan={2}>Player</th>
