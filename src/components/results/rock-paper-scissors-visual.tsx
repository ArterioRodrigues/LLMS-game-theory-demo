      ...
      <div className="grid">
        <div className="card">
          ...
          <div className="rational-section">
            ...
            <p className="rational-behavior">{currentPattern.rational}</p>
          </div>
          ...
          <div className="pattern-visualization">
            <div className="move-sequence">
              ...
              {selectedPattern === 'probabilistic-pattern' && (
                <div className="moves">
                  <span className="move rock prob-move">
                    🪨
                    <br />
                    60%
                  </span>
                  <span className="move paper prob-move">
                    📄
                    <br />
                    20%
                  </span>
                  <span className="move scissors prob-move">
                    ✂️
                    <br />
                    20%
                  </span>
          ...
          <div className="performance-section">
            <div className="model-performance">
              ...
              <div className="score-bar-bg">
                <div className="score-bar score-low" style={{ width: `${getScoreWidth(currentPattern.performance.gpt3.score)}%` }}></div>
              </div>
