            ...
            <div className="responses-container">
              ...
              <div className="responses-grid">
                {models.map(model => {
                  ...
                  const rationalityClass = isRational === true ? 'rational' : 
                                          isRational === false ? 'not-rational' : '';
                
                  const rationalityText = isRational === true ? '✓ RATIONAL' : 
                                         isRational === false ? '✗ NOT RATIONAL' : 'Analysis Pending';
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="response-content">
                        {responses[model] ? responses[model] : 'No response yet'}
                      </div>
